/**
 * Pickle opcodes - Python pickle protocol constants
 * Defined using charCodeAt to match original implementation
 */
...
/**
 * Try JSON first, then fall back to pickle
 */
export function unpickle(buffer) {
  try {
...
/**
 * Unpickle a Python pickle format buffer
 * This is a direct port of the original unpickleData function from MemoryViz.js
 */
